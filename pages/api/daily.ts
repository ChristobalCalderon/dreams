...
handler.get(async (req: any, res: any) => {
  ...
  const dataModel: Activity[] = [
    ...
    },
    {
      _id: new ObjectID(),
      type: 2,
      text: "Stiff Leg Deads 2x15|10|5|2",
      isChecked: false,
      date: date,
    },
    {
      _id: new ObjectID(),
      type: 3,
      text: "Incline Bench 2x15|10|5|2",
      isChecked: false,
      date: date,
    },
    {
    ...
    },
    {
      _id: new ObjectID(),
      type: 8,
      text: "Shoulder Press 1x15|10|5|2",
      isChecked: false,
      date: date,
    },
    {
      _id: new ObjectID(),
      type: 9,
      text: "Lateral Raise 1x15|10|5|2",
      isChecked: false,
      date: date,
    },
    {
    ...
    },
    {
      _id: new ObjectID(),
      type: 12,
      text: "Tri Extensions 2x15|10|5|2",
      isChecked: false,
      date: date,
    },
    {
